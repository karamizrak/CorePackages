...
using ValidationException = MinistryOfHealth.Core.CrossCuttingConcerns.Exception.Types.ValidationException;

namespace MinistryOfHealth.Core.Application.Pipelines.Validation;
